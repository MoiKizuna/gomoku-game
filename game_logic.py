...
class GomokuGame:
    ...
    def evaluate_board(self):
        score = 0
        patterns = [
            (1000000000, 'OOOOO'),    # AI 五连，极高权重
            (-1000000000, 'XXXXX'),   # 玩家五连，极高负权重
            (800000, '_OOOO_'),       # AI 活四，极高权重
            (-900000, '_XXXX_'),      # 玩家 活四，极高负权重
            (400000, 'OOOO_'),        # AI 冲四，较高权重
            (-450000, 'XXXX_'),       # 玩家 冲四，较高负权重
            (400000, '_OOOO'),        # AI 冲四，较高权重
            (-450000, '_XXXX'),       # 玩家 冲四，较高负权重
            (200000, 'OOO_O'),        # AI 跳四，较高权重
            (-250000, 'XXX_X'),       # 玩家 跳四，较高负权重
            (100000, '_OOO__'),       # AI 活三，较高权重
            (-120000, '_XXX__'),      # 玩家 活三，较高负权重
            (100000, '__OOO_'),       # AI 活三，较高权重
            (-120000, '__XXX_'),      # 玩家 活三，较高负权重
            (50000, 'OO_X_'),         # AI 跳三，中等权重
            (-60000, 'XX_O_'),        # 玩家 跳三，中等负权重
            (20000, '_OO__'),         # AI 活二，较低权重
            (-25000, '_XX__'),        # 玩家 活二，较低负权重
            (20000, '__OO_'),         # AI 活二，较低权重
            (-25000, '__XX_'),        # 玩家 活二，较低负权重
            (10000, 'O__O'),          # AI 眠二，最低权重
            (-8000, 'X__X'),          # 玩家 眠二，最低负权重
        ]
